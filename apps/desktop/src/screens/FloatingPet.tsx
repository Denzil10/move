      ...
      {activeTask?.id === "move" && (
        <div className="bubble move-bubble">
          <div className="move-header">
            ...
            <button className="snooze-icon" aria-label="Later" onClick={handleSnooze} title="Later">
      ...
      {activeTask && activeTask.id !== "move" && (
        <div className="bubble">
          ...
          <div className="bubble-actions">
            ...
            <button className="bubble-btn later" aria-label="Later" onClick={handleSnooze} title="Later">
