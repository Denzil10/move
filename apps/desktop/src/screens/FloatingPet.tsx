      ...
      {activeTask?.id === "move" && (
        <div className="bubble move-bubble">
          <div className="move-header">
            ...
            <button className="snooze-icon" onClick={handleSnooze} title="Later" aria-label="Later">
      ...
      {activeTask && activeTask.id !== "move" && (
        <div className="bubble">
          ...
          <div className="bubble-actions">
            <button className="bubble-btn done" onClick={() => handleTaskComplete(activeTask.id)} title="Done" aria-label="Done">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
            </button>
            <button className="bubble-btn later" onClick={handleSnooze} title="Later" aria-label="Later">
