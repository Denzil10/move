      ...
      {activeTask?.id === "move" && (
        <div className="bubble move-bubble">
          <div className="move-header">
            ...
            <button className="snooze-icon" onClick={handleSnooze} title="Later" aria-label="Snooze task for later">
      ...
      {activeTask && activeTask.id !== "move" && (
        <div className="bubble">
          ...
          <div className="bubble-actions">
            ...
            <button className="bubble-btn later" onClick={handleSnooze} title="Later" aria-label="Snooze task for later">
