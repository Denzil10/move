      ...
      {activeTask?.id === "move" && (
        <div className="bubble move-bubble">
          <div className="move-header">
            ...
            <button className="snooze-icon" aria-label="Snooze reminder" onClick={handleSnooze} title="Later">
      ...
      {activeTask && activeTask.id !== "move" && (
        <div className="bubble">
          ...
          <div className="bubble-actions">
            <button className="bubble-btn done" aria-label="Mark task done" onClick={() => handleTaskComplete(activeTask.id)} title="Done">
