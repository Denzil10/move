export type PersonalityType = 'supportive' | 'hyper' | 'lazy' | 'grumpy' | 'zen';
...
export const PERSONALITIES: Personality[] = [
  {
    ...
    thoughts: {
      ...
      stretch: ["Maybe a quick stretch would feel good?", "I'm ready to move whenever you are! 🐉", "How about we try a small arm circle?", "A deep breath and a quick stand-up?", "Your future self will thank you for moving now!"],
      recap: {
  ...
  },
  {
    ...
    thoughts: {
      ...
      stretch: ["*Yawns* If we move, can we nap right after?", "If you stand up, maybe I can find a better spot to lie down.", "Moving? *Sigh* If you say so...", "A quick stretch and then back to the couch?", "I'll move if you promise treats later."],
      recap: {
  ...
  },
  {
    ...
    thoughts: {
      ...
      stretch: ["My back is killing me, and you're not helping by just sitting there.", "Move already! My pixels are cramping.", "You call that posture? Go on, move.", "If you don't move soon, I'm going to start making noise.", "Look at us, just staring at a screen. Pathetic. Move."],
      recap: {
  ...
  },
  {
    ...
    thoughts: {
      ...
      stretch: ["STRETCH TIME! LET'S DO IT NOW NOW NOW!", "CAN WE JUMP? OR SPIN? OR BOTH?!", "GO GO GO! I'M READY!", "ZOOMIES INCOMING! STAND UP!", "SPEEDY STRETCH! LET'S BE LIGHTNING!"],
      recap: {
      ...
      weather: {
        ...
        rainy: ["SPLASH! SPLASH! MOVEMENT IN THE RAIN!", "SPEED THROUGH THE DROPLETS!", "RAIN IS JUST LIQUID MOTIVATION!", "DANCE IN THE RAIN! MOVE IN THE APP!"],
  ...
  },
  {
    ...
    thoughts: {
      ...
      stretch: ["Inhale movement, exhale stillness.", "Find the flow in a gentle stretch.", "The body wishes to breathe through motion.", "A mindful moment for your muscles.", "Balance your day with a little dance."],
      recap: {
